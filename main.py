...
display(f'{product_flavor} {product_names[0]}', target='Super_Pretzel_product') # string + list
display(f'{menu_prices[0]} ₱', target='Super_Pretzel_price')# tuple

display(f'{product_flavor} {product_names[1]}', target='Pretzel_Bum_product') # string + list
display(f'{menu_prices[1]} ₱', target='Pretzel_Bum_price')# tuple

display(f'{product_flavor} {product_names[2]}', target='Coffee_product') # string + list
display(f'{menu_prices[2]} ₱', target='Coffee_price')# tuple

display(f'{product_flavor} {product_names[3]}', target='Pretzel_Crisps_product') # string + list
display(f'{menu_prices[3]} ₱', target='Pretzel_Crisps_price')# tuple

display(f'{product_flavor} {product_names[4]}', target='Cheese_Dip_product') # string + list
display(f'{menu_prices[4]} ₱', target='Cheese_Dip_price')# tuple

display(f'{product_flavor} {product_names[5]}', target='Mini_Pretzel_Box_product') # string + list
display(f'{menu_prices[5]} ₱', target='Mini_Pretzel_Box_price')# tuple

display(f'{product_flavor} {product_names[6]}', target='Stuffed_Pretzel_product') # string + list
display(f'{menu_prices[6]} ₱', target='Stuffed_Pretzel_price')# tuple

display(f'{product_flavor} {product_names[7]}', target='Pretzel_Sandwich_product') # string + list
